...
var getCountry = country => {
    var countryDisplay = document.querySelector('.country>span');
...
export { Weather, getIcon, getWindSpeed, getHumidity, getCountry, getTemp, getTempMinMax, getDescription };